package com.globalpayments.library.utilities;
...
public class PermissionHelper {
    ...
    public static void onRequestPermissionsResult(final Activity activity, int requestCode,
            @NonNull String[] permissions, @NonNull int[] grantResults, final PermissionsCallBack callBack) {
    ...
    private static void showAlertDialog(Context context,
        ...
        new AlertDialog.Builder(context)
                .setMessage(
                        "Some permissions are not granted. Application may not work as expected. Do you want to grant them?")
